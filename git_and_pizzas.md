...
CentOs7 installation (write in your terminal): *sudo yum install git*.
Windows installation: download (https://git-scm.com/downloads) and execute it.
...
Terminal or *Git Bash* instructions:
...
0. It's mandatory: every project should be a differentiated folder/directory.
...
##### Available everywhere (uploading and downloading):
...
##### Usual workflow (downloading and uploading):
...
- before starting to work, launching this command is very recommended -
